...
public:
    ...
    string to_string()
    {
        ...
        string estudiante = "Codigo: " + codigo_estudiante + " Nombre: " + getNombres() + " " + getApellidos() + " DNI: " + getDNI();
        return estudiante;
    }
    ...
    void getDatos()
    {
        cout << "//////////////////////////////////////////"
             << endl
             << "LOS DATOS DEL ESTUDIANTE ES: " << endl
             << "codigo: " << codigo_estudiante << endl
             << "nombre: " << getNombres() << " " << getApellidos() << endl
             << "DNI: " << getDNI();
        cout << "\n";
    }
